...
error_t chapAbortAuth(PppContext *context)
{
   ...
   // motivi che ti possono portare qui:
   TRACE_INFO("Did you set the right APN ?? \r\n");
   TRACE_INFO("Did you turn off the MODEM ?? \r\n"); //nella procedura di spegnimento (corretta!) il modem invia messaggio LCP di chiusura
