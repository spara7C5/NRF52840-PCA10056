...
/* Modification */
// TODO: Verificare se e' il modo giusto
#include "cmsis_os.h"

#include "compiler_port.h"


//extern osMutexId UART_debug_mut_Handle;
//extern osMessageQId Queue_MODEMHandle;
extern osMutexId MutCBUFFHandle;
...
/*#ifndef TRACE_PRINTF
   #define TRACE_PRINTF(...) \
   xQueueReceive(Queue_MODEMHandle, &rxmex, 0);	\
		if (rxmex){	\
			if (xSemaphoreTake(UART_debug_mut_Handle, 10)){ fprintf(stderr, __VA_ARGS__);  osMutexRelease(UART_debug_mut_Handle);}	\
		}
#endif*/
...
//void debugInit(uint32_t baudrate); //TODO: anche questo e' stato modificato
